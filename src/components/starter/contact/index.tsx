    ...
    <>
      <section id="contact-section" class="w-full flex flex-col md:flex-row justify-start md:justify-around items-center py-10 my-10 bg-black text-white">
        ...
        <div class="w-3/4 md:w-1/3 flex md:justify-end md:items-center">
          <button class="w-full md:w-fit bg-button-grad rounded-full font-bold py-12 px-4 border border-transparent hover:border-gray-500 hover:bg-clip-text hover:bg-button-grad hover:text-transparent duration-700" type="button">
            Contact Me
          </button>
        </div>
      </section>
